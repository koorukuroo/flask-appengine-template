...
authomatic = Authomatic(CONFIG, 'SECRET KEY', report_errors=False)
...
def login(provider_name):
    ...
    if result:
        if result.user:
            ...
            session['user_name'] = urllib.quote(result.user.name)
            ...
            session['error'] = urllib.quote(result.error.message)
